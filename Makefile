...
SRCS	=	ft_atof.c			ft_atoi.c		ft_bzero.c			ft_calloc.c			ft_free_matrix.c	\
			...
			ft_lstsize.c		ft_lxtoa.c		ft_matrix_len.c		ft_memchr.c			ft_memcmp.c			\
			ft_memcpy.c			ft_memmove.c	ft_memset.c			ft_printf.c			ft_putchar_fd.c		\
			ft_putendl_fd.c		ft_putnbr_fd.c	ft_putstr_fd.c		ft_read_file.c		ft_split.c			\
			ft_split_lines.c	ft_strchr.c		ft_strdup.c			ft_striteri.c		ft_strjoin.c		\
			ft_strlcat.c		ft_strlcpy.c	ft_strlen.c			ft_strmapi.c		ft_strncmp.c		\
			ft_strnstr.c		ft_strrchr.c	ft_strtrim.c		ft_strupper.c		ft_substr.c			\
